							...
							WHERE CODIGOCLIENTEC = PARAM_CODIGOCLIENTE LIMIT 1;
								...
								ELSE
									...
									WHILE CONTA < NUMEROPRODUTOS DO
										...
										SELECT CODIGOPRODUTOC INTO CODIGOPRODUTO FROM CARRINHO_COMPRA WHERE CODIGOCLIENTEC = PARAM_CODIGOCLIENTE LIMIT 1 OFFSET CONTA;
                                        SELECT PRECOC INTO PRECO FROM CARRINHO_COMPRA WHERE CODIGOCLIENTEC = PARAM_CODIGOCLIENTE LIMIT 1 OFFSET CONTA;
                                        SELECT QUANTIDADEC INTO QUANTIDADEPRODUTOS FROM CARRINHO_COMPRA WHERE CODIGOCLIENTEC = PARAM_CODIGOCLIENTE LIMIT 1 OFFSET CONTA;
                                        
										CALL GERAR_ITEM_PEDIDO(CODIGOPRODUTO, CONTA, QUANTIDADEPRODUTOS, PRECO, VAR_NUMEROPEDIDO, @RESULTAD);
...
DELIMITER $
CREATE PROCEDURE GERAR_ITEM_PEDIDO(IN VAR_CODIGOPRODUTO VARCHAR(15), IN CONTADOR INT, IN VAR_QUANTIDADEPRODUTOS INT, IN VAR_PRECO INT, IN VAR_NUMEROPEDIDO INT, OUT VAR_RESULTADO VARCHAR(80))
BEGIN
